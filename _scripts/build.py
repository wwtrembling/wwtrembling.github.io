...
TOOLS_CONFIG = [
    ...
    # Conversion + general utility
    ('file-size-converter', '💾', FILE_SIZE_CONVERTER),
...
TOOL_CATEGORIES = {
    ...
    'sleep-calculator': 'calc', 'water-intake': 'calc',
    'age-calculator': 'calc',
    # File size converter sits with other unit/format converters.
    'file-size-converter': 'convert',
    # Reading-time fits more naturally with text utilities than calculators.
    'reading-time': 'text',
    # AI-era utilities
...
if __name__ == '__main__':
    ...
    # Lifestyle / utility tools
    build_tool('sleep-calculator', SLEEP_CALCULATOR, 'sleep-calculator.html')
    build_tool('reading-time', READING_TIME, 'reading-time.html')
    build_tool('water-intake', WATER_INTAKE, 'water-intake.html')
    # Conversion + general utility
    build_tool('file-size-converter', FILE_SIZE_CONVERTER, 'file-size-converter.html')
    build_tool('age-calculator', AGE_CALCULATOR, 'age-calculator.html')
